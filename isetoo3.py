...
temperatuurid = [
    jaanuar := [-16, -12, -15, -20, 0, -1, -20, -2, -20, -14, -18, -8, 2, -1, -14, -7, -15, -17, -6, -17, -17, -7, 0, 3, -20, -17, -15, -8, -12, 3],
    veebruar := [-9, -2, -7, 100, -16, -19, -19, -11, -16, -15, -9, -2, -16, -4, -20, -5, -6, -17, -5, 0, -16, 2, 0, -20, -16, -2, -18],
...
suurim_igas_kuus = [max(jaanuar), max(veebruar), max(märts), max(aprill), max(mai), max(juuni), max(juuli), max(august), max(september), max(oktoober), max(november), max(detsember)]
kuud = ["jaanuar", "veebruar", "märts", "aprill", "mai", "juuni", "juuli", "august", "september", "oktoober", "november", "detsember"]
kuupaeva_arvutus_kuu = suurim_igas_kuus.index(max(suurim_igas_kuus)) + 1
kuupaeva_arvutus_paev = (max(temperatuurid[kuupaeva_arvutus_kuu - 1])) + 1  

print(f"kõrgeim temeratuur aastas oli {max(suurim_igas_kuus)} ning see oli kuupäeval {kuupaeva_arvutus_paev}.{kuud[kuupaeva_arvutus_kuu - 1] }")
